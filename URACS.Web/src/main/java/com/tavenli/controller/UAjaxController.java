...
public class UAjaxController extends UBaseController {
	...
	public Map<String, Object> queryUsers(Model model, Integer page,
		...
		PageData<UserEntity> pageData = this.uCenterService.getUsers(page,
				pageSize, userName);
		...
		resMap.put("pageNav", PageNavUtil.getAjaxPageNavHtml(page.intValue(),
				pageSize, pageData.getTotalCount(), 15));
	...
	@ResponseBody
	public Map<String, Object> saveRoleResource(Model model, int roleId,
			String menuIds) {
		boolean resultStatus = true;
		Map<String, Object> resMap = new HashMap<String, Object>();
